- [视频与素材获取链接](#---------)
- [[Unity]3D胡闹厨房复刻](#-unity-3d------)
  * [01 创建项目](#01-----)
    + [001 3DURP和git](#001-3durp-git)
      - [[1] 创建项目](#-1------)
        * [a:选择3dURP模板](#a---3durp--)
        * [b:设置URP](#b---urp)
        * [c:Layout布局](#c-layout--)
      - [[2] 项目管理](#-2------)
        * [a:Github Desktop](#a-github-desktop)
        * [b:Unity项目的回滚注意事项](#b-unity---------)
        * [c:VS的基本配置](#c-vs-----)
        * [d:导入素材](#d-----)
        * [e:基本场景搭建](#e-------)
        * [f:Scene窗口移动和相机预设](#f-scene---------)
        * [g:后处理](#g----)
  * [02 简陋实现](#02-----)
    + [001 玩家控制器](#001------)
      - [[1]简单移动](#-1-----)
        * [a:逻辑与动画分离](#a--------)
        * [b:新建脚本`Player.cs`](#b------playercs-)
        * [c:Debug](#c-debug)
      - [[2]简单旋转](#-2-----)
        * [a:修改脚本`Player.cs`](#a------playercs-)
      - [[3]简单动画](#-3-----)
        * [a:动画控制器](#a------)
        * [b:新建脚本`PlayerAnimator.cs`](#b------playeranimatorcs-)
        * [c:修改脚本`Player.cs`](#c------playercs-)
        * [d:Debug](#d-debug)
    + [002 镜头和重构](#002------)
      - [[1]cinemachine实现镜头跟随](#-1-cinemachine------)
        * [a:操作](#a---)
      - [[2]重构之前的输入系统](#-2----------)
        * [a:新建脚本`GameInput.cs`](#a------gameinputcs-)
        * [b:修改脚本`Player.cs`](#b------playercs-)
      - [[3]新输入系统重构](#-3--------)
        * [a:安装](#a---)
        * [b:修改脚本`GameInput.cs`](#b------gameinputcs-)
      - [[4]碰撞](#-4---)
        * [a:修改脚本`Player.cs`](#a------playercs--1)
        * [b:Debug](#b-debug)
  * [03 游戏机制](#03-----)
    + [001 交互操作](#001-----)
      - [[1]清空柜台](#-1-----)
        * [a:修改脚本`Player.cs`](#a------playercs--2)
        * [b:新建脚本`ClearCounter.cs`](#b------clearcountercs-)
        * [c:Debug](#c-debug-1)
      - [[2]交互实现](#-2-----)
        * [a:输入映射](#a-----)
        * [b:修改脚本`GameInput.cs`](#b------gameinputcs--1)
        * [c:修改脚本`Player.cs`](#c------playercs--1)
        * [d:Debug](#d-debug-1)
      - [[3]交互提示](#-3-----)
        * [a:新建脚本`SelectedCounterVisual`](#a------selectedcountervisual-)
        * [b:修改脚本`Player.cs`](#b------playercs--1)
        * [c:Debug](#c-debug-2)
    + [002 捡起与放下物品](#002--------)
      - [[1]厨房对象](#-1-----)
        * [a:修改脚本`ClearCounter.cs`](#a------clearcountercs-)
        * [b:新建脚本`KitchenObjectSO.cs`](#b------kitchenobjectsocs-)
        * [c:继续修改`ClearCounter.cs`](#c------clearcountercs-)
        * [d:新建脚本`KitchenObject.cs`](#d------kitchenobjectcs-)
      - [[2]厨房父对象](#-2------)
        * [a:修改脚本`ClearCounter.cs`](#a------clearcountercs--1)
        * [b:修改脚本`KitchenObject.cs`](#b------kitchenobjectcs-)
      - [[3]玩家捡起](#-3-----)
        * [a:新建脚本`IKitchenObjectParent.cs`](#a------ikitchenobjectparentcs-)
        * [b:修改脚本`ClearCounter.cs`](#b------clearcountercs-)
        * [c:修改脚本`KitchenObject.cs`](#c------kitchenobjectcs-)
        * [d:修改脚本`Player.cs`](#d------playercs-)
      - [[4]货柜](#-4---)
        * [a:新建脚本`BaseCounter.cs`](#a------basecountercs-)
        * [b:新建脚本`ContainerCounter.cs`](#b------containercountercs-)
        * [c:修改脚本`ClearCounter.cs`](#c------clearcountercs-)
        * [d:修改脚本`Player.cs`](#d------playercs--1)
        * [e:修改脚本`SelectedCounterVisual.cs`](#e------selectedcountervisualcs-)
        * [f:新建脚本`ContainerCounterVisual.cs`](#f------containercountervisualcs-)
        * [g:Debug](#g-debug)
    + [003 切东西和扔垃圾](#003--------)
      - [[1]视觉改进](#-1-----)
        * [a:修改脚本`Player.cs`](#a------playercs--3)
      - [[2]切割柜台](#-2-----)
        * [a:修改脚本`GameInput.cs`](#a------gameinputcs-)
        * [b:新建脚本`CuttingCounter.cs`](#b------cuttingcountercs-)
        * [c:修改脚本`Player.cs`](#c------playercs--2)
        * [d:修改脚本`BaseCounter.cs`](#d------basecountercs-)
        * [e:新建脚本`CuttingRecipeSO`](#e------cuttingrecipeso-)
        * [f:新建脚本`ProgressBarUI.cs`](#f------progressbaruics-)
        * [g:新建脚本`CuttingCounterVisual.cs`](#g------cuttingcountervisualcs-)
        * [h:新建脚本`LookAtCamera.cs`](#h------lookatcameracs-)
        * [i:BUG](#i-bug)
      - [[3]垃圾桶](#-3----)
        * [a:新建脚本`TrashCounter.cs`](#a------trashcountercs-)
    + [004 灶台和盘子](#004------)
      - [[1]灶台烤东西](#-1------)
        * [a:新建脚本`StoveCounter.cs`](#a------stovecountercs-)
        * [b:新建脚本`FryingRecipeSO.cs`](#b------fryingrecipesocs-)
        * [c:新建脚本`BurningRecipeSO.cs`](#c------burningrecipesocs-)
        * [d:新建脚本`StoveCounterVisual.cs`](#d------stovecountervisualcs-)
        * [e:新建脚本`IHasProgress.cs`](#e------ihasprogresscs-)
        * [f:修改脚本`ProgressBarUI.cs`](#f------progressbaruics-)
        * [g:修改脚本`CuttingCounter.cs`](#g------cuttingcountercs-)
      - [[2]盘子柜台](#-2-----)
        * [a:新建脚本`PlatesCounter.cs`](#a------platescountercs-)
        * [b:新建脚本`PlatesCounterVisual.cs`](#b------platescountervisualcs-)
        * [c:Debug](#c-debug-3)
    + [005 用上碟盘](#005-----)
      - [[1]加入食物的数据](#-1--------)
        * [a:新建脚本`PlateKitchenObject.cs`](#a------platekitchenobjectcs-)
        * [b:修改脚本`ClearCounter.cs`](#b------clearcountercs--1)
        * [c:Debug](#c-debug-4)
      - [[2]改进加入食物的逻辑](#-2----------)
        * [a:修改脚本`PlateKitchenObject.cs`](#a------platekitchenobjectcs-)
        * [b:修改脚本`ClearCounter.cs`](#b------clearcountercs--2)
        * [c:修改脚本`KitchenObject.cs`](#c------kitchenobjectcs--1)
        * [d:修改脚本`CuttingCounter.cs`](#d------cuttingcountercs-)
        * [e:修改脚本`StoveCounter.cs`](#e------stovecountercs-)
      - [[3]添加视觉效果](#-3-------)
        * [a:新建脚本`PlateCompleteVisual.cs`](#a------platecompletevisualcs-)
        * [b:修改脚本`PlateKitchenObject.cs`](#b------platekitchenobjectcs-)
      - [[4]改进添加视觉效果](#-4---------)
        * [a:制作图标UI](#a-----ui)
        * [b:修改脚本`PlateKitchenObject.cs`](#b------platekitchenobjectcs--1)
        * [c:新建脚本`PlateIconsUI.cs`](#c------plateiconsuics-)
        * [d:新建脚本`PlateIconsSingleUI.cs`](#d------plateiconssingleuics-)
    + [006 送货柜台](#006-----)
      - [[1]实现柜台](#-1-----)
        * [a:新建脚本`DeliveryCounter.cs`](#a------deliverycountercs-)
        * [b:实现`MovingVisual.shadergraph`](#b----movingvisualshadergraph-)
        * [c:最终效果](#c-----)
      - [[2]继续改进完成交付逻辑](#-2-----------)
        * [a:新建脚本`DeliveryManager.cs`](#a------deliverymanagercs-)
        * [b:新建脚本`RecipeSO.cs`](#b------recipesocs-)
        * [c:新建脚本`RecipeListSO.cs`](#c------recipelistsocs-)
        * [d:修改脚本`DeliveryCounter.cs`](#d------deliverycountercs-)
      - [[3]增加UI交付食物提示](#-3---ui------)
        * [a:新建脚本`DeliveryManagerUI.cs`](#a------deliverymanageruics-)
        * [b:修改脚本`DeliveryManager.cs`](#b------deliverymanagercs-)
        * [c:新建脚本`DeliverManagerSingleUI.cs`](#c------delivermanagersingleuics-)
        * [d:UI提示](#d-ui--)
      - [[4]BG音乐_MusicManager游戏对象](#-4-bg---musicmanager----)
      - [[5]音效管理](#-5-----)
        * [a:新建脚本`SoundManager.cs`](#a------soundmanagercs-)
        * [b:修改脚本`DeliveryManager.cs`](#b------deliverymanagercs--1)
        * [c:新建脚本`AudioClipRefsSO.cs`](#c------audiocliprefssocs-)
        * [d:修改脚本`DeliveryCounter.cs`](#d------deliverycountercs--1)
        * [e:修改脚本`CuttingCounter.cs`](#e------cuttingcountercs-)
        * [f:修改脚本`Player.cs`](#f------playercs-)
        * [g:修改脚本`BaseCounter.cs`](#g------basecountercs-)
        * [h:修改脚本`TrashCounter.cs`](#h------trashcountercs-)
        * [i:新建脚本`StoveCounterSound.cs`](#i------stovecountersoundcs-)
        * [j:新建脚本`PlayerSounds.cs`](#j------playersoundscs-)
    + [007 游戏开始和结束](#007--------)
      - [[1]具体实现](#-1-----)
        * [a:新建脚本`KitchenGameManager.cs`](#a------kitchengamemanagercs-)
        * [b:修改脚本`player.cs`](#b------playercs-)
        * [c:新建脚本`GameStartCountdownUI.cs`](#c------gamestartcountdownuics-)
        * [d:新建脚本`GameOverUI.cs`](#d------gameoveruics-)
        * [e:修改脚本`DeliveryManager.cs`](#e------deliverymanagercs-)
        * [f:新建脚本`GamePlayingClockUI.cs`](#f------gameplayingclockuics-)
  * [04 系统界面与优化](#04--------)
    + [001 系统界面UI相关](#001-----ui--)
      - [[1]游戏开始、退出、加载](#-1-----------)
        * [a:UGUI实现主菜单场景的UI](#a-ugui--------ui)
        * [b:UGUI实现加载场景的UI](#b-ugui-------ui)
        * [注意事项：](#-----)
        * [c:新建脚本`MainMenuUI.cs`](#c------mainmenuuics-)
        * [d:新建脚本`Loader.cs`](#d------loadercs-)
        * [e:新建脚本`LoaderCallback.cs`](#e------loadercallbackcs-)
        * [g:Debug](#g-debug-1)
      - [[2]游戏暂停](#-2-----)
        * [a:修改脚本`GameInput.cs`](#a------gameinputcs--1)
        * [b:修改脚本`KitchenGameManager.cs`](#b------kitchengamemanagercs-)
        * [c:UGUI新建暂停UI界面](#c-ugui----ui--)
        * [d:新建脚本`GamePauseUI.cs`](#d------gamepauseuics-)
        * [e:新建脚本`ResetStaticDataManager.cs`](#e------resetstaticdatamanagercs-)
        * [f:Debug](#f-debug)
      - [[3]音效声音大小管理](#-3---------)
        * [a:UGUI实现UI界面](#a-ugui--ui--)
        * [b:修改脚本`SoundManager.cs`](#b------soundmanagercs-)
        * [c:新建脚本`OptionsUI.cs`](#c------optionsuics-)
        * [d:新建脚本`MusicManager.cs`](#d------musicmanagercs-)
        * [e:Debug](#e-debug)
      - [[4]按键切换](#-4-----)
        * [a:UGUI](#a-ugui)
        * [b:修改脚本`OptionsUI.cs`](#b------optionsuics-)
        * [c:修改脚本`GameInput.cs`](#c------gameinputcs-)
        * [d:Debug](#d-debug-2)
      - [[5]手柄输入](#-5-----)
        * [a:输入映射和UI](#a------ui)
        * [b:修改脚本`Player.cs`](#b------playercs--2)
        * [c:修改脚本`GameInput.cs`](#c------gameinputcs--1)
        * [d:修改脚本`OptionsUI.cs`](#d------optionsuics-)
        * [e:修改脚本`GamePauseUI.cs`](#e------gamepauseuics-)
        * [f:Debug](#f-debug-1)
      - [[6]自动导航](#-6-----)
        * [a:第一种处理方式](#a--------)
        * [b:第二种处理方式](#b--------)
    ...
    + [002 小优化](#002----)
      ...
      - [[2] 移动优化](#-2------)
      - [[3] 游戏引导](#-3------)
        * [a:新建挂载的脚本`TutorialUI.cs`](#a---------tutorialuics-)
        * [b:修改脚本`KitchenGameManager.cs`](#b------kitchengamemanagercs--1)
        * [c:修改脚本`DeliveryManager.cs`](#c------deliverymanagercs-)
        * [d:修改脚本`PlatesCounter.cs`](#d------platescountercs-)
        * [e:Debug](#e-debug-1)
      - [[4] 改进游戏开始前倒计时](#-4------------)
        * [a:动画控制器](#a-------1)
        * [b:修改脚本`GameStartCountdownUI.cs`](#b------gamestartcountdownuics-)
        * [c:修改脚本`SoundManager.cs`](#c------soundmanagercs-)
        * [d:Debug](#d-debug-3)
      - [[5]改进烤炉的视觉提示](#-5----------)
        * [a:UGUI](#a-ugui-1)
        * [b:修改脚本`StoveCounter.cs`](#b------stovecountercs-)
        * [c:修改脚本`StoveBurnWarningUI.cs`](#c------stoveburnwarninguics-)
        * [d:修改脚本`StoveCounterSound.cs`](#d------stovecountersoundcs-)
        * [e:修改脚本`StoveBurnFlashingBarUI.cs`](#e------stoveburnflashingbaruics-)
      - [[6]改进交付的视觉提示](#-6----------)
        * [a:UGUI](#a-ugui-2)
        * [b:`DeliveryResultUI.cs`](#b--deliveryresultuics-)
        * [c:最终的debug效果：](#c----debug---)
  * [05 联机实现](#05-----)
    + [001 准备](#001---)
      - [[1]安装下载包与试用](#-1---------)
        * [a:Netcode](#a-netcode)
        * [b:新建脚本`NetworkManager.cs`](#b------networkmanagercs-)
        * [c:Mono变成Network](#c-mono--network)
        * [d:Debug首次尝试体验联机与单机的区别](#d-debug--------------)
        * [e:UGUI封装`NetworkManager`界面操作](#e-ugui---networkmanager-----)
        * [f:新建脚本`TestingNetcodeUI.cs`](#f------testingnetcodeuics-)
        * [g:专门的联机Debug操作](#g------debug--)
      - [[2]Netcode的问题和bug解决方式](#-2-netcode----bug----)
        * [a:错误日志1](#a-----1)
        * [b:错误日志2](#b-----2)
        * [c:错误日志3](#c-----3)
        * [d:错误日志4](#d-----4)
    ...
    + [002 简单接触](#002-----)
      - [[1]同步移动](#-1-----)
        * [a:`server authoritative`](#a--server-authoritative-)
        * [b:第1种方式`client authoritative`](#b--1----client-authoritative-)
        * [c:第2种方式`服务端同步位置`](#c--2------------)
      - [[2]同步动画](#-2-----)
        * [a:第1种方式`服务端授权给客户端`](#a--1--------------)
        * [b:第2种方式`服务端权威`](#b--2----------)
      - [[3]总结与区分不同Rpc](#-3--------rpc)
        * [a:`[ServerRpc]`](#a---serverrpc--)
        * [b:`[ClientRpc]`](#b---clientrpc--)
    + [003 修改交互](#003-----)
      - [[1]交付柜台](#-1-----)
        * [a:修改脚本`DeliveryManager.cs`](#a------deliverymanagercs-)
        * [b:使用netcode的注意事项](#b---netcode-----)
        * [c:使用rpc的问题：](#c---rpc----)
      - [[2]修复交互提示功能](#-2---------)
        * [a:修改脚本`Player.cs`](#a------playercs--4)
        * [b:修改脚本`SelectedCounterVisual.cs`](#b------selectedcountervisualcs-)
        * [c:修改脚本`ResetstaticDataManager.cs`](#c------resetstaticdatamanagercs-)
        * [d:修改脚本`SoundManager`](#d------soundmanager-)
      - [[3]同步玩家拾取物品](#-3---------)
        * [a:将厨房物品都变成联网对象](#a-------------)
        * [b:新建脚本`KitchenGameMultiplayer.cs`](#b------kitchengamemultiplayercs-)
        * [c:新建脚本`KitchenObjectListSO.cs`](#c------kitchenobjectlistsocs-)
        * [d:修改脚本`IKitchenObjectParent.cs`](#d------ikitchenobjectparentcs-)
        * [e:修改脚本`BaseCounter.cs`](#e------basecountercs-)
        * [f:修改脚本`Player.cs`](#f------playercs--1)
      - [[4]同步父级对象](#-4-------)
        * [a:为什么联网对象最好不要有涉及父类修改的操作？](#a-----------------------)
        * [b:新建脚本`FollowTransform.cs`](#b------followtransformcs-)
        * [c:修改脚本`KitchenObject.cs`](#c------kitchenobjectcs--2)
        * [d:修改脚本`BaseCounter.cs`](#d------basecountercs--1)
        * [e:修改脚本`PlateKitchenObject.cs`](#e------platekitchenobjectcs-)
        * [f:修改脚本`ContainerCounter.cs`](#f------containercountercs-)
      - [[5]总结](#-5---)
    + [004 同步客户端与服务端的数据](#004-------------)
      - [[1]同步盘子的生成数量](#-1----------)
        * [a:修改脚本`PlatesCounter.cs`](#a------platescountercs-)
        * [b:新建脚本`PlateVisualSO.cs`](#b------platevisualsocs-)
        * [c:修改脚本`PlatesCounterVisual.cs`](#c------platescountervisualcs-)
      - [[2]销毁网络对象](#-2-------)
        * [a:修改脚本`KitchenObject.cs`](#a------kitchenobjectcs-)
        * [b:修改脚本`DeliveryCounter.cs`](#b------deliverycountercs-)
        * [c:修改脚本`TrashCounter.cs`](#c------trashcountercs-)
        * [d:修改脚本`KitchenGameMultiplayer.cs`](#d------kitchengamemultiplayercs-)
      - [[3]同步切割柜台进度](#-3---------)
        * [a:修改脚本`CuttingCounter.cs`](#a------cuttingcountercs-)
      - [[4]同步灶台的进度](#-4--------)
        * [a:修改脚本`StoveCounter.cs`](#a------stovecountercs-)
      - [[5]同步碟中配菜](#-5-------)
        * [a:修改脚本`PlateKitchenObject.cs`](#a------platekitchenobjectcs--1)
        * [b:修改脚本`ClearCounter.cs`](#b------clearcountercs--3)
      - [[6]总结](#-6---)
    + [005 改进](#005---)
      - [[1]同步玩家碰撞](#-1-------)
        * [a:修改脚本`Player.cs`](#a------playercs--5)
      - [[2]同步状态](#-2-----)
        * [a:修改脚本`KitchenGameManager.cs`](#a------kitchengamemanagercs-)
        * [b:修改脚本`TutorialUI.cs`](#b------tutorialuics-)
        * [c:新建脚本`WaitingForOtherPlayersUI.cs`](#c------waitingforotherplayersuics-)
      - [[3]同步暂停状态](#-3-------)
        * [a:修改脚本`KitchenGameManager.cs`](#a------kitchengamemanagercs--1)
        * [b:修改脚本`GamePauseUI.cs`](#b------gamepauseuics-)
        * [c:新建脚本`PauseMultiplayerUI.cs`](#c------pausemultiplayeruics-)
      - [[4]处理断连](#-4-----)
        * [a:修改脚本`Player.cs`](#a------playercs--6)
        * [b:修改脚本`KitchenGameManager.cs`](#b------kitchengamemanagercs--2)
        * [c:新建脚本`HostDisconnectUI.cs`](#c------hostdisconnectuics-)
        * [d:解决问题4](#d-----4)
      - [[5]处理延迟](#-5-----)
        * [a:修改脚本`KitchenGameMultiplayer.cs`](#a------kitchengamemultiplayercs-)
        * [b:修改脚本`TestingNetcodeUI.cs`](#b------testingnetcodeuics-)
        * [c:修改脚本`KitchenGameManager.cs`](#c------kitchengamemanagercs-)
        * [d:Debug](#d-debug-4)
    + [006 连接场景流程](#006-------)
      - [[1]Lobby场景](#-1-lobby--)
        * [a:UGUI](#a-ugui-3)
        * [b:新建脚本`TestingLobbyUI.cs`](#b------testinglobbyuics-)
        * [c:修改脚本`Loader.cs`](#c------loadercs-)
        * [d:修改脚本`KitchenGameMultiplayer.cs`](#d------kitchengamemultiplayercs--1)
      - [[2]CharacterSelectScene](#-2-characterselectscene)
        * [a:UGUI](#a-ugui-4)
        * [b:新建脚本`TestingCharacterSelectUI.cs`](#b------testingcharacterselectuics-)
        * [c:新建脚本`CharacterSelectReady.cs`](#c------characterselectreadycs-)
        * [d:新建脚本`ConnectionResponseMessageUI.cs`](#d------connectionresponsemessageuics-)
        * [e:新建脚本`ConnectingUI.cs`](#e------connectinguics-)
        * [f:修改脚本`KitchenGameManager.cs`](#f------kitchengamemanagercs-)
        * [g:修改脚本`KitchenGameMultiplayer.cs`](#g------kitchengamemultiplayercs-)
        * [h:Debug](#h-debug)
      - [[3]菜单场景](#-3-----)
        * [a:新建脚本`MainMenuCleanUp.cs`](#a------mainmenucleanupcs-)
        * [b:修改脚本`MainMenuUI.cs`](#b------mainmenuuics-)
    + [007 角色选择场景](#007-------)
      - [[1]重改界面](#-1-----)
        * [a:新建脚本`CharacterSelectUI.cs`](#a------characterselectuics-)
        * [b:新建脚本`CharacterSelectPlayer.cs`](#b------characterselectplayercs-)
        * [c:新建脚本`PlayerData.cs`](#c------playerdatacs-)
        * [d:修改脚本`KitchenGameMultiplayer.cs`](#d------kitchengamemultiplayercs--2)
        * [e:修改脚本`CharacterSelectReady.cs`](#e------characterselectreadycs-)
      - [[2]选择颜色](#-2-----)
        * [a:修改脚本`KitchenGameMultiplayer.cs`](#a------kitchengamemultiplayercs--1)
        * [b:新建脚本`PlayerVisual.cs`](#b------playervisualcs-)
        * [c:新建脚本`CharacterSelectPlayer.cs`](#c------characterselectplayercs-)
        * [d:新建脚本`CharacterColorSelectSingleUI.cs`](#d------charactercolorselectsingleuics-)
        * [e:修改脚本`PlayerData.cs`](#e------playerdatacs-)
        * [f:修改脚本`HostDisconnectUI.cs`](#f------hostdisconnectuics-)
        * [g:修改脚本`Player.cs`](#g------playercs-)
    + [008 重改连接大厅](#008-------)
      - [[1]准备工作](#-1-----)
      - [[2]重写新建与加入房间操作](#-2------------)
        * [a:新建脚本`KitchenGameLobby.cs`](#a------kitchengamelobbycs-)
        * [b:修改脚本`MainMenuCleanUp.cs`](#b------mainmenucleanupcs-)
        * [c:修改脚本`LobbyUI.cs`](#c------lobbyuics-)
      - [[3]创建用户名与私人房间号](#-3------------)
        * [a:新建脚本`LobbyCreateUI.cs`](#a------lobbycreateuics-)
        * [b:修改脚本`LobbyUI.cs`](#b------lobbyuics-)
        * [c:修改脚本`CharacterSelectUI.cs`](#c------characterselectuics-)
        * [d:修改脚本`KitchenGameMultiplayer.cs`](#d------kitchengamemultiplayercs--3)
        * [e:修改脚本`CharacterSelectPlayer.cs`](#e------characterselectplayercs-)
        * [f:修改脚本`PlayerData.cs`](#f------playerdatacs-)
        * [g:修改脚本`CharacterSelectReady.cs`](#g------characterselectreadycs-)
      - [[4]改动相应的连接提示](#-4----------)
        * [a:UGUI](#a-ugui-5)
        * [b:修改脚本`LobbyMessageUI.cs`](#b------lobbymessageuics-)
      - [[5]弄多几个大厅](#-5-------)
        * [a:修改脚本`LobbyUI.cs`](#a------lobbyuics-)
        * [b:新建脚本`LobbyListSingleUI.cs`](#b------lobbylistsingleuics-)
    + [009 中继器](#009----)
      - [[1]准备](#-1---)
      - [[2]分配](#-2---)
        * [a:修改脚本`KitchenGameLobby.cs`](#a------kitchengamelobbycs-)
    + [010 其他](#010---)
      - [工具](#--)
